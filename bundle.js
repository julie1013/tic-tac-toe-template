...
/***/ function(module, exports, __webpack_require__) {
	...
	var playHandlers = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isPlayerTurn = function isPlayerTurn() {
	  if (whoseTurn === 0) {
	    player = 'x';
	  } else {
	    player = 'o';
	...
	var isVacantCell = function isVacantCell(cell) {
	  return currentGame.game.cells[cell] === "";
	};
	//checks if cell is vacant

	var setCellData = function setCellData(cell, player) {
	  currentGame.game.cells[cell] = player;
	  return player;
	};

	var horizontalWin = function horizontalWin() {
	  if (currentGame.game.cells[0] && currentGame.game.cells[0] === currentGame.game.cells[1] && currentGame.game.cells[0] === currentGame.game.cells[2]) {
	    winner = currentGame.game.cells[0];
	  } else if (currentGame.game.cells[3] && currentGame.game.cells[3] === currentGame.game.cells[4] && currentGame.game.cells[3] === currentGame.game.cells[5]) {
	    winner = currentGame.game.cells[3];
	  } else if (currentGame.game.cells[6] && currentGame.game.cells[6] === currentGame.game.cells[7] && currentGame.game.cells[6] === currentGame.game.cells[8]) {
	...
	var verticalWin = function verticalWin() {
	  if (currentGame.game.cells[0] && currentGame.game.cells[0] === currentGame.game.cells[3] && currentGame.game.cells[0] === currentGame.game.cells[6]) {
	    winner = currentGame.game.cells[0];
	  } else if (currentGame.game.cells[1] && currentGame.game.cells[1] === currentGame.game.cells[4] && currentGame.game.cells[1] === currentGame.game.cells[7]) {
	    winner = currentGame.game.cells[1];
	  } else if (currentGame.game.cells[2] && currentGame.game.cells[2] === currentGame.game.cells[5] && currentGame.game.cells[2] === currentGame.game.cells[8]) {
	...
	var tieCheck = function tieCheck() {
	  var count = 0;
	  for (var i = 0; i < currentGame.game.cells.length; i++) {
	...
	var winnerDeclare = function winnerDeclare() {
	  var declaration = "" + winner + " has won this round!";
	  return declaration;
	};

	var restartGameData = function restartGameData() {
	...
	module.exports = {
	  ...
	  restartGameData: restartGameData,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var drawBoard = function drawBoard(array) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onNewGame = function onNewGame(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.newGame(data).done(ui.onNewGameSuccess).fail(ui.onError);
	};

	var onGetGames = function onGetGames(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.getGames(data).done(ui.onGetGamesSuccess).fail(ui.onError);
	};

	var onUpdateBoard = function onUpdateBoard(cell) {
	  api.updateBoard(cell).done().fail(ui.onError);
	};

	var onGamesPlayed = function onGamesPlayed(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.gamesPlayed(data).done(ui.onGamesPlayedSuccess).fail(ui.onError);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateBoard = function updateBoard(cell) {
	  var cellVal = logic.currentGame.game.cells[cell];
	  var gameID = app.game.id;
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameOverUpdate = function gameOverUpdate() {
	  return $.ajax({
